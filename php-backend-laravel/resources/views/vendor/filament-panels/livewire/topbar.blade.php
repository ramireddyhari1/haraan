<div class="fi-topbar-ctn hrn-topbar-ctn">
    @php
    ...
    <nav class="fi-topbar hrn-glass-topbar">
        ...
        @if ($hasNavigation)
            <x-filament::icon-button
                ...
                class="fi-topbar-open-sidebar-btn hrn-topbar-btn"
            />
            ...
            <x-filament::icon-button
                ...
                x-show="$store.sidebar.isOpen"
                class="fi-topbar-close-sidebar-btn hrn-topbar-btn"
            />
        @endif

        <div class="fi-topbar-start hrn-topbar-start">
            @if ($isSidebarCollapsibleOnDesktop || $isSidebarFullyCollapsibleOnDesktop)
                <div
                    x-show="$store.sidebar.isOpen || @js($isSidebarCollapsibleOnDesktop)"
                    class="fi-topbar-collapse-sidebar-btn-ctn hrn-collapse-btn-wrapper"
                >
                    @if ($isSidebarCollapsibleOnDesktop)
                        <x-filament::icon-button
                            ...
                            x-on:click="$store.sidebar.open()"
                            x-show="! $store.sidebar.isOpen"
                            class="fi-topbar-open-collapse-sidebar-btn hrn-topbar-btn"
                        />
                    @endif
                    ...
                    @if ($isSidebarCollapsibleOnDesktop || $isSidebarFullyCollapsibleOnDesktop)
                        <x-filament::icon-button
                            ...
                            x-on:click="$store.sidebar.close()"
                            x-show="$store.sidebar.isOpen"
                            class="fi-topbar-close-collapse-sidebar-btn hrn-topbar-btn"
                        />
                    @endif
                </div>
            @endif
            ...
            {{-- Haraan Brand Anchor: Desktop & Mobile Single Source of Truth --}}
            <div class="hrn-topbar-brand-anchor-ctn">
                <x-haraan-brand-anchor />
            </div>
        ...
        @if ($hasTopNavigation || (! $hasNavigation))
            ...
            @if ($hasNavigation)
                ...
                <ul class="fi-topbar-nav-groups hrn-topbar-nav-groups">
        ...
        <div
            ...
            @endif
            class="fi-topbar-end hrn-topbar-end"
        >
